...
|------|--------|-------|-----|
| Research Scan | ⚠️ | No investment angles in output | Mandatory format with "Investment angle:" per item |
| SG Briefing | ⚠️ | 2/3 runs = "quiet news day" | Reduced to Mon/Wed/Fri |
| Free Exploration | ⚠️ | 143s runtime, low relevance | Added investment relevance gate, capped at 300s |
| Kids Dinner | ✅ | Working great | Keep as-is |
| Talebian Lens | ✅ | Sharp, actionable | Keep as-is |
| World State | ✅ | Pipeline works | Keep as-is |

**Changes Made:**
1. Research Scan: New mandatory output format with `Investment angle: [trade]` per finding
2. SG Briefing: Daily → Mon/Wed/Fri (was 40% hit rate)
3. Free Exploration: Added investment relevance gate, timeout 900s → 300s, max 3 ReAct cycles
